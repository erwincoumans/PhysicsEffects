...
inline
bool pointOnLine(const Vector3 &p,const Vector3 &a,const Vector3 &b)
{
	return dot(p-a,b-a) > (1.0f-0.00001f);
}

// 線分a,b上に点pがあるかどうかを判定
inline
bool pointOnSegment(const Vector3 &p,const Vector3 &a,const Vector3 &b)
{
	Vector3 ab = b-a;
	Vector3 ap = p-a;
	Vector3 bp = p-b;
